...
<input type ="hidden" id = "c_id" name = "clientid" value = "<?php echo $new_clientid[0] -> id + 1 ?>" />
...
<tr>
	<td>NDQ Number</td>
	<td><input type="text" name ="ndqno" class = "validate[required]" /></td>
</tr>
...
<tr>
<td><label>Product Description</label></td><td><textarea name="description" id="product_desc" title="Describe how product looks like"  ></textarea></td>
...
<div id ="fancybox_label" class = "hidden2" >
  <form id = "print_label">
	...
	<div>
		<span>Label for </span><span id ="ndqno" class = "label_ndqno"></span>
	</div>
	<div>
		<ul id = "testlist"></ul>
	</div>
	<div class = "clear">
		...
		<div class = "right_align">
			<input type ="text" name="no_or_prints" class="validate[required]" />
		</div>
		<div class = "left_align">
