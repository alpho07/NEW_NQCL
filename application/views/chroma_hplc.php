	...
	<table id="tests">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" name="limits"  required /></td>
...
<div>
	<legend>
	<a id="bufferprep_show" class="div_show" href="#">
		<span class="minus_plus">+</span>&nbsp;Preparation of Buffer</a>
</legend>
...
<div>
<legend>
<a id="mobilephase" class="div_show" href="#">
<span class="minus_plus">+</span>&nbsp;Preparation of Mobile Phase</a>
</legend>
...
<div>
<legend>
<a id="sys_suit_sol" class="div_show" href="#">
<span class="minus_plus">+</span>&nbsp;Preparation of System Suitability Solutions</a>
</legend>
...
<span class="minus_plus">+</span>&nbsp;Chromatographic System</a>
</legend>
...
<table id="tests">
	<tr>
		<td><label for="column_no" >Column No.</label></td><td><select name="column_no" ><option value="" >Select Column</option></select></td>
	</tr>
	<tr>
		<td><label for="column_type" >Type of Column</label></td><td><input type="text" name="column_type" readonly /></td>
		<td><label for="column_temp" >Column Temp (ºC)</label></td><td><input type="text" name="column_temp" required /></td>
	</tr>
	<tr>
		<td><label for="detection" >Detection λ (nm)</label></td><td><input type="text" name="detection" value="" required /></td>
		<td><label for="injection" >Injection Vol (μL)</label></td><td><input type="text" name="injection" value="" required /></td>
	</tr>
	<tr>
		<td><label for="flow_rate" >Flow Rate (mL/min)</label></td><td><input type="text" name="flow_rate" value="" required /></td>
		<td><label for="pump_pressure" >Pump Pressure (bars)</label></td><td><input type="text" name="pump_pressure" value="" required /></td>
	</tr>
</table>
