...
<legend><a href="<?php echo site_url() ."documentation/home/"; ?>">Analyzed Samples</a>&nbsp;||&nbsp;<a href="<?php echo site_url() ."documentation/reviewed/"; ?>">Reviewed Samples&nbsp;||&nbsp;<a href="<?php echo site_url() ."documentation/fromDirector/"; ?>">Samples From The Director </a>&nbsp;||&nbsp;<a href="<?php echo site_url() ."documentation_rejects/home/"; ?>">Rejected Samples </a></legend>        <div>&nbsp;</div>
                ...
                <tbody class="tablebody">
                    ...
                    <?php foreach ($documentation_data as $sheets) : ?>	
                        ...
                        <tr>
                            ...
                            <td  class="bold assign" ><strong><em><?php echo $sheets->labref ?></em></strong>&nbsp;&nbsp;&nbsp;<?php echo anchor('assign/assing_reviewer/' . $sheets->labref, 'Assign') ?></td>

                            <td><?php echo $sheets->supervisor_name ?></td>

                            <td><?php echo $sheets->analyst_name ?></td>
                            <td><?php echo $sheets->test_name ?></td>
                            <td><?php echo $sheets->test_product ?></td>
