...
$(document).ready(function(){
    ...
    <p>
<p><h3><<<a href='<?php echo base_url().'supervisors/home/'.$labref;?>'>Back</a></h3> <center><legend><h2>Sample Results: <?php echo $labref;?> </h2></legend></center></p>
    </p>
    <hr /> 
      <?php echo form_open('assay/approve/'.$labref.'/'.$r); ?>
   <p><input type="submit" value="Approve" style="background-color: #33ff33;color: #ffffff;"/>&nbsp;&nbsp;<input type="submit" value="Reject" style="background-color: #F00; color: #ffffff;"/></p>
