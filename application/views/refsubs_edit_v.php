...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td class ="dor hidden2 "><input name ="date_res" type = "text" id = "date_res" class ="validate[required]"  placeholder = "e.g 02-OCT-2013" value = "<?php echo $refsub -> date_of_restandardisation ?>"  /></td>
		</tr>
