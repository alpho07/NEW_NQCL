...
$(document).ready(function(){
      ...
      var nda='No Value';
       $(".assay_data[value='0']" ).val(nda);
        $(".assay_data[value='1']" ).val(nda);
         $(".assay_data[value='0']" ).css("color", "red");
        $(".assay_data[value='1']").css("color", "red");
    ...
    <p>
    <p><h3><<<a href='<?php echo base_url().'supervisors/home/'.$labref;?>'>Back</a></h3> <center><legend><h2>Sample Results: <?php echo $labref;?>&nbsp;&nbsp;Component: <?php echo $component_name[0]->component;?></h2></legend></center></p>
<p>Components No.:</p>
<?php
foreach ($no_of_pages as $pages):
    echo anchor('assay/assa_r_multiple/' . $labref . '/' . $r . '/' . $pages, '<strong>' . $pages . " " . '</strong>');
endforeach;
?>
...
foreach ($no_of_repeats as $page_repeats):
    echo anchor('assay/assa_r_multiple/' . $labref . '/' . $page_repeats . '/' . $r, '<strong>' . $page_repeats . " " . '</strong>');
endforeach;
?>
    </p>
    <hr /> 
      <?php echo form_open('assay/approve/'.$labref.'/'.$r); ?>
    ...
    <div>
        ...
        <table id ="sample">		
            ...
            <tr>
                ...
                <td class="dillution1" >
                    <input type="text" required id="sp11" value="<?php echo $sample_assay_standars_abc[0]->pipette2;?>" class="assay_data" name="sp11" size="15" readonly/> 
                </td>
                <td class="dillution1">
                ...
                <td class="vf3head"><input type="text" required id="spf1" value="<?php echo $sample_assay_standars_abc[0]->pippette3;?>" class="assay_data" name="spf1" size="15"  readonly /></td>
...
<!--============================================================================================================================================-->
        ...
        <hr />
        <div><center><textarea value="" class="assay_data1" name="procedure" cols="100" rows="5" placeholder="please describe the procedure you have used" required="true"><?php echo $sample_assay_desired_weight[0]->preparation_proc;?></textarea></center></div>
        </p>
        <?php echo form_close(); ?>
