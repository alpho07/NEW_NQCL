...
echo form_open('request_management/update', $attributes);
...
<!--tr><td><input type="submit" class="submit-button" value="Update Client"  /></td></tr>
</form>
</table-->
...
<input type="hidden" name="testsissued[]" id="testsissued" value="<?php echo $tests_issued ?>" />
