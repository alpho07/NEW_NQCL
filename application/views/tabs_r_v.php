...
<div id="Individual_box">
   ...
   <p><input type="submit" value="Approve" style="background-color: #33ff33;color: #ffffff;"/>&nbsp;&nbsp;<a href="#rejectSample" id="Inline" style="background-color: #F00; color: #ffffff;">Reject</a></p>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv1" name="tcsv1" size="25" value="<?php echo $tabs_results[0]->tcsv; ?>" class="num" required /></td>               
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv2" name="tcsv2" value="<?php echo $tabs_results[1]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv3" name="tcsv3"  value="<?php echo $tabs_results[2]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv4" name="tcsv4" value="<?php echo $tabs_results[3]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv5" name="tcsv5" size="25" value="<?php echo $tabs_results[4]->tcsv; ?>" class="num" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv6" name="tcsv6" size="25" value="<?php echo $tabs_results[5]->tcsv; ?>" class="num" required /></td>                
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv7" name="tcsv7" size="25" value="<?php echo $tabs_results[6]->tcsv; ?>" class="num" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv8" name="tcsv8" size="25" value="<?php echo $tabs_results[7]->tcsv; ?>" class="num"  required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv9" name="tcsv9" size="25" value="<?php echo $tabs_results[8]->tcsv; ?>" class="num"  required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv10"  name="tcsv10" value="<?php echo $tabs_results[9]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv11" name="tcsv11" value="<?php echo $tabs_results[10]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv12" name="tcsv12" value="<?php echo $tabs_results[11]->tcsv; ?>" class="num" size="25" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv13"  name="tcsv13" size="25" value="<?php echo $tabs_results[12]->tcsv; ?>" class="num" required /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv14" name="tcsv14" size="25" required value="<?php echo $tabs_results[13]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv15" name="tcsv15" size="25" required value="<?php echo $tabs_results[14]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv16" name="tcsv16" size="25" required value="<?php echo $tabs_results[15]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv17"name="tcsv17" size="25" required value="<?php echo $tabs_results[16]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="tcsv18" name="tcsv18" size="25" value="<?php echo $tabs_results[17]->tcsv; ?>" class="num" required /></td>
        ...
        <tr>
            ...
            <td><input type="text"id="tcsv19" name="tcsv19" size="25" required value="<?php echo $tabs_results[18]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text"id="tcsv20"  name="tcsv20" size="25" required value="<?php echo $tabs_results[19]->tcsv; ?>" class="num" /></td>
        ...
        <tr>
            ...
            <td><input type="text" id="totals" name="totalss" readonly class="num4" value="<?php echo $tabs_ta[0]->total?>"/></td>


        </tr>
        <tr>
            <td><div align="center">Average</div></td>
            <td><input type="text" id="av1" name="average" readonly class="num4"  value="<?php echo $tabs_ta[0]->average?>"/></td>
