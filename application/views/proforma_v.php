<html>
	...
	<body>
		<div>
				<div><hgroup><h3>Proforma Invoice for <?php $reqid = $this -> uri -> segment(4); $rid  = $this -> uri -> segment(3); echo $reqid; ?> </h3><h4>Cost of Analysis of Listed Samples</h4></hgroup></div>
				<hr/>
				<div>
					...
					<table id ="proforma">
						...
						<tbody>
							...
							<tr class = "others">
								...
								<td><span><?php echo $sample[0]['active_ing'] ?></span></td>
		...
		<div>
			<input type = "submit" class = "submit-button" value = "Print" id = "<?php echo $reqid; ?>" data-alias = "print" data-rid = "<?php echo $rid; ?>" />
		</div>
	</body>
