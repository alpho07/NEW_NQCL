...
<table>
	...
	<tbody>
		<tr>
			...
			<td><label for = "serial_no">Manufacturer</label></td>
			<td><input name ="serial_no" type = "text" class ="validate[required]" placeholder ="e.g S09TY" /></td>
		</tr>
		<tr>
			<td><label for = "nqcl_no">NQCL No.</label></td>
			<td><input name ="nqcl_no" type = "text" class ="validate[required]" placeholder ="e.g NDQD.." /></td>
		...
		<tr>
			...
			<td><select name = "status" class = "validate[required]">
                 ...
                 <option value = "In Use">Decommissioned</option> 
			</select></td>
		</tr>
		<tr>
