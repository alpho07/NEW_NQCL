...
$(document).ready(function()
{
        ...
        $("#workingvf1,#workingp1,#workingvf2,#workingp2,#workingvf3,#workingp3,#workingvf4").change(function()
        {
            ...
            $('#number,#vf1,#p1,#vf2,#p2,#vf31,#p321,#vf32,#number1,#vf11,#p11,#vf22,#ppt1,#vf33,#ppt2,#vf34').change('live',function() {
...
//==============================================SAMPLE PREPARATION====================================//
$(document).ready(function(){
    $("#svf1,#sp1,#svf2,#pwnumber,#tabs_caps_average,#aiweight,#smgml,#aiweightA,#aiweightB,#aiweightC,#sampleA,#sampleB,#sampleC,#svf11,#svf111,#svf3,#svf13,#svf23,#svf24,#sp11,#sp112,#spf1,#spf2,#spf3,#p3,#svf12,#svf22,#svf33,#labelclaim,#vf3,#pipette2,#pipette3,#vf41").live('change',function()
    {
